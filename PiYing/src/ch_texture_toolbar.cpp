...
ChTextureToolbar::ChTextureToolbar() :
	...
	_add_triangle(new ToolButton(":/PiYing/piying_icons/addChVert_S.png", ":/PiYing/piying_icons/addChVert.png", "addChVert", CharacterToolState::AddTriangle)),
	_add_poly(new ToolButton(":/PiYing/piying_icons/chAddPoly_S.png", ":/PiYing/piying_icons/chAddPoly.png", "chAddPoly", CharacterToolState::AddPoly)),
	_add_round(new ToolButton(":/PiYing/piying_icons/chAddRound_S.png", ":/PiYing/piying_icons/chAddRound.png", "chAddRound", CharacterToolState::AddRound))
{
