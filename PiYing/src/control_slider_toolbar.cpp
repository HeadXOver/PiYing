...
void ControlSliderToolbar::press_1()
{
	...
	case CharacterToolState::RectSelectPart:
	...
	case CharacterToolState::LibreSelectPart:
	...
	default: {
		if (_select->toolState() == CharacterToolState::RectSelectTrianglePart ||
			_select->toolState() == CharacterToolState::RectSelectPart) {
			_select->set_selected(":/PiYing/piying_icons/selectRectChVert_S.png");
			_select->set_unselected(":/PiYing/piying_icons/selectRectChVert.png");
			_select->set_toolState(CharacterToolState::RectSelectVertPart);
		}
		else if (_select->toolState() == CharacterToolState::LibreSelectTrianglePart ||
			_select->toolState() == CharacterToolState::LibreSelectPart) {
			_select->set_selected(":/PiYing/piying_icons/selectLibreChVert_S.png");
			_select->set_unselected(":/PiYing/piying_icons/selectLibreChVert.png");
			_select->set_toolState(CharacterToolState::LibreSelectVertPart);
		}
...
void ControlSliderToolbar::press_4()
{
	switch (PiYingGL::getInstance().ch_tool_state()) {
	case CharacterToolState::RectSelectTrianglePart:
	case CharacterToolState::RectSelectVertPart: {
		_select->set_selected(":/PiYing/piying_icons/rect_select_S.png");
		_select->set_unselected(":/PiYing/piying_icons/rect_select.png");
		_select->set_toolState(CharacterToolState::RectSelectPart);
		_select->update();
		PiYingGL::getInstance().setChTool(CharacterToolState::RectSelectPart);
	}break;
	case CharacterToolState::LibreSelectTrianglePart:
	case CharacterToolState::LibreSelectVertPart: {
		_select->set_selected(":/PiYing/piying_icons/libre_select_S.png");
		_select->set_unselected(":/PiYing/piying_icons/libre_select.png");
		_select->set_toolState(CharacterToolState::LibreSelectPart);
		_select->update();
		PiYingGL::getInstance().setChTool(CharacterToolState::LibreSelectPart);
	}break;
	case CharacterToolState::LibreSelectPart:
	case CharacterToolState::RectSelectPart: return;
	default: {
		if (_select->toolState() == CharacterToolState::RectSelectVertPart ||
			_select->toolState() == CharacterToolState::RectSelectTrianglePart) {
			_select->set_selected(":/PiYing/piying_icons/rect_triangle_select_S.png");
			_select->set_unselected(":/PiYing/piying_icons/rect_triangle_select.png");
			_select->set_toolState(CharacterToolState::RectSelectPart);
		}
		else if (_select->toolState() == CharacterToolState::LibreSelectVertPart ||
			_select->toolState() == CharacterToolState::LibreSelectTrianglePart) {
			_select->set_selected(":/PiYing/piying_icons/libre_triangle_select_S.png");
			_select->set_unselected(":/PiYing/piying_icons/libre_triangle_select.png");
			_select->set_toolState(CharacterToolState::LibreSelectPart);
		}
