...
RatioDialog::RatioDialog(QWidget* parent) :
    QDialog(parent),
    m_buttons(QDialogButtonBox::Ok | QDialogButtonBox::Cancel, Qt::Horizontal, this)
{
...
void RatioDialog::buildUi()
{
    ...
    for (int i = 0; i < presets.size(); ++i) {
        auto* rb = new QRadioButton(presets[i].first, this);
    ...
    customLay->addWidget(new QLabel(tr("自定义"), this));
